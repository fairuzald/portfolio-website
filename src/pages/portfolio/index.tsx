  ...
  return (
    <>
      ...
      <Layout>
        <section
          id="#"
          className="w-full px-20 min-h-screen bg-gradient-to-b from-[#22273B]  to-[#1C2034] py-[11vh] lg:py-[18vh]"
        >
          <div className="w-full px-4">
            <div className="mx-auto mb-10 max-w-xl text-center">
              ...
              >
                Here are some of the projects I have made. Regarding other
                project details, you can see via the view more button under the
                project
              </p>
            </div>
            <div
